...
QT_MOC_LITERAL(1, 12, 18), // "doubleValueChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5), // "param"
QT_MOC_LITERAL(4, 38, 5), // "value"
QT_MOC_LITERAL(5, 44, 15), // "intValueChanged"
QT_MOC_LITERAL(6, 60, 22), // "doubleSpinEditFinished"
QT_MOC_LITERAL(7, 83, 19), // "intSpinEditFinished"
QT_MOC_LITERAL(8, 103, 17), // "comboIndexChanged"
QT_MOC_LITERAL(9, 121, 5), // "index"
QT_MOC_LITERAL(10, 127, 18), // "valueSliderPressed"
QT_MOC_LITERAL(11, 146, 19), // "valueSliderReleased"
QT_MOC_LITERAL(12, 166, 18) // "valueSliderChanged"

    },
    "ParamWidget\0doubleValueChanged\0\0param\0"
    "value\0intValueChanged\0doubleSpinEditFinished\0"
    "intSpinEditFinished\0comboIndexChanged\0"
    "index\0valueSliderPressed\0valueSliderReleased\0"
    "valueSliderChanged"
};
...
void ParamWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->valueSliderPressed(); break;
        case 6: _t->valueSliderReleased(); break;
        case 7: _t->valueSliderChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ParamWidget::*_t)(QString , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParamWidget::doubleValueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ParamWidget::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParamWidget::intValueChanged)) {
                *result = 1;
                return;
            }
        }
