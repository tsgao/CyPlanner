...
void MapRipForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapRipForm::beginRip)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MapRipForm::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapRipForm::cancelRip)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MapRipForm::shouldAutoRip)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject MapRipForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MapRipForm.data,
      qt_meta_data_MapRipForm,  qt_static_metacall, nullptr, nullptr}
};
