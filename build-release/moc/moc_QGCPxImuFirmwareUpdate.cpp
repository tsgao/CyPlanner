...
struct qt_meta_stringdata_QGCPxImuFirmwareUpdate_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QGCPxImuFirmwareUpdate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QGCPxImuFirmwareUpdate_t qt_meta_stringdata_QGCPxImuFirmwareUpdate = {
    {
QT_MOC_LITERAL(0, 0, 22) // "QGCPxImuFirmwareUpdate"
...
const QMetaObject QGCPxImuFirmwareUpdate::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCPxImuFirmwareUpdate.data,
      qt_meta_data_QGCPxImuFirmwareUpdate,  qt_static_metacall, nullptr, nullptr}
};
...
void *QGCPxImuFirmwareUpdate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QGCPxImuFirmwareUpdate.stringdata0))
