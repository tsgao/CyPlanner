...
void APMToolBar::setMultiFlightPlanViewAction(QAction *action)
{
...
/*
 * Author: Xiangwei Niu
 * trigger MultiFlightPlanView
 */
void APMToolBar::selectMultiFlightPlanView()
{
    QLOG_DEBUG() << "APMToolBar: SelectMultiFlightPlanView";
    emit triggerMultiFlightPlanView();
}
