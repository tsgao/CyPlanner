#include "uasview_copy.h"
#include "ui_uasview_copy.h"
#include "logging.h"
#include "QGC.h"
...
UASView_copy::UASView_copy(UASInterface* uas, QWidget *parent):
    QWidget(parent),
    startTime(0),
    timeout(false),
    iconIsRed(true),
...
void UASView_copy::heartbeatTimeout(bool timeout, unsigned int ms)
{
    Q_UNUSED(ms);
    this->timeout = timeout;
}

void UASView_copy::updateNavMode(int uasid, int mode, const QString& text)
{
    Q_UNUSED(uasid);
    Q_UNUSED(mode);
...
void UASView_copy::showStatusText(int uasid, int componentid, int severity, QString text)
{
    Q_UNUSED(uasid);
 ...
 */
void UASView_copy::setBackgroundColor()
{
    // UAS color
...
void UASView_copy::setUASasActive(bool active)
{
    if (active)
    {
...
void UASView_copy::updateActiveUAS(UASInterface* uas, bool active)
{
    if (uas == this->uas)
    {
...
void UASView_copy::updateMode(int sysId, QString status, QString description)
{
...
void UASView_copy::mouseDoubleClickEvent (QMouseEvent * event)
{
    Q_UNUSED(event);
...
void UASView_copy::enterEvent(QEvent* event)
{
...
void UASView_copy::leaveEvent(QEvent* event)
{
    if (event->type() == QEvent::MouseMove)
    {
...
void UASView_copy::showEvent(QShowEvent* event)
{
...
void UASView_copy::hideEvent(QHideEvent* event)
{
    // React only to internal (pre-display)
    // events
    Q_UNUSED(event);
...
void UASView_copy::receiveHeartbeat(UASInterface* uas)
{
    Q_UNUSED(uas);
...
void UASView_copy::updateName(const QString& name)
{
 ...
 */
void UASView_copy::setSystemType(UASInterface* uas, unsigned int systemType)
{
    if (uas == this->uas)
    {
        // Set matching icon
...
void UASView_copy::updateLocalPosition(UASInterface* uas, double x, double y, double z, quint64 usec)
{
    Q_UNUSED(usec);
    Q_UNUSED(uas);
    this->x = x;
...
void UASView_copy::updateGlobalPosition(UASInterface* uas, double lon, double lat, double alt, quint64 usec)
{
    Q_UNUSED(uas);
    Q_UNUSED(usec);
    this->lon = lon;
...
void UASView_copy::updateSpeed(UASInterface*, double x, double y, double z, quint64 usec)
{
    Q_UNUSED(usec);
    totalSpeed = sqrt(x*x + y*y + z*z);
}

void UASView_copy::currentWaypointUpdated(quint16 waypoint)
{
    m_ui->waypointLabel->setText(tr("WP") + QString::number(waypoint));
}

void UASView_copy::setWaypoint(int uasId, int id, double x, double y, double z, double yaw, bool autocontinue, bool current)
{
    Q_UNUSED(x);
    Q_UNUSED(y);
    Q_UNUSED(z);
...
void UASView_copy::selectWaypoint(int uasId, int id)
{
    if (uasId == this->uas->getUASID())
    {
        m_ui->waypointLabel->setText(tr("WP") + QString::number(id));
...
void UASView_copy::updateThrust(UASInterface* uas, double thrust)
{
    if (this->uas == uas)
    {
        this->thrust = thrust;
...
void UASView_copy::updateBattery(UASInterface* uas, double voltage, double current, double percent, int seconds)
{
    Q_UNUSED(voltage);
    Q_UNUSED(current);
    if (this->uas == uas)
...
void UASView_copy::updateState(UASInterface* uas, QString uasState, QString stateDescription)
{
    if (this->uas == uas)
    {
        state = uasState;
...
void UASView_copy::updateLoad(UASInterface* uas, double load)
{
    if (this->uas == uas)
    {
        this->load = load;
